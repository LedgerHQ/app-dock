...
#define PD_CALL_SCHEDULER_V1 21
#define PD_CALL_BABE_V1 29
#define PD_CALL_TIMESTAMP_V1 1
#define PD_CALL_BALANCES_V1 2
#define PD_CALL_AUTHORSHIP_V1 6
#define PD_CALL_STAKING_V1 30
#define PD_CALL_OFFENCES_V1 32
#define PD_CALL_SESSION_V1 3
#define PD_CALL_GRANDPA_V1 5
#define PD_CALL_IMONLINE_V1 28
#define PD_CALL_AUTHORITYDISCOVERY_V1 26
#define PD_CALL_DEMOCRACY_V1 17
#define PD_CALL_COUNCIL_V1 18
#define PD_CALL_TECHNICALCOMMITTEE_V1 19
#define PD_CALL_ELECTIONS_V1 36
#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_V1 20
#define PD_CALL_TREASURY_V1 33
#define PD_CALL_UTILITY_V1 8
#define PD_CALL_IDENTITY_V1 38
#define PD_CALL_BOUNTIES_V1 34
#define PD_CALL_TIPS_V1 37
#define PD_CALL_ELECTIONPROVIDERMULTIPHASE_V1 31
#define PD_CALL_POAMODULE_V1 4
#define PD_CALL_DIDMODULE_V1 9
#define PD_CALL_REVOKE_V1 10
#define PD_CALL_BLOB_STORE_V1 11
#define PD_CALL_ANCHOR_V1 15
#define PD_CALL_ATTEST_V1 16
